...
const ReplayIcon = ({ width = 16, height = 16, className, replayOne = false }) => {
    return (
        <>
            {replayOne ? (
                <svg
...
const VolumnIcon = ({ width = 16, height = 16, className, level = 'medium' }) => {
    return (
        <>
            {level === 'low' && (
                <svg
...
const ArrowIcon = ({ width = 16, height = 16, className, isLeftDirection = false }) => {
    return (
        <svg
            width={width}
            height={height}
            ...
            aria-hidden="true"
            viewBox="0 0 16 16"
            className={`first-letter:Svg-sc-ytk21e-0 kgVuXA ${className}`}
        >
            {!isLeftDirection && (
