        ...
        <>
            ...
            <div className="w-full flex-auto flex flex-col justify-between bg-[#121212] rounded-md">
                ...
                <div className="relative h-[132px] flex-auto">
                    <span
                        ref={shadow}
                        className="absolute w-full h-2 bg-transparent top-0 left-0 shadow-blur hidden"
                    ></span>
                    <div
                        className="w-full h-full my-2 px-2 overflow-y-auto overflow-x-hidden"
                        onScroll={handleScroll}
                    >
                        <div className="w-full h-[356px] flex flex-col justify-between">
