...
const LibraryIcon = ({ width = 24, height = 24, className, isActive = false }) => {
    return (
        <svg
            width={width}
            height={height}
        ...
        >
            {isActive && <path d="M14.5 2.134a1 1 0 0 1 1 0l6 3.464a1 1 0 0 1 .5.866V21a1 1 0 0 1-1 1h-6a1 1 0 0 1-1-1V3a1 1 0 0 1 .5-.866zM16 4.732V20h4V7.041l-4-2.309zM3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zm6 0a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1z"></path>}
            {!isActive && <path d="M3 22a1 1 0 0 1-1-1V3a1 1 0 0 1 2 0v18a1 1 0 0 1-1 1zM15.5 2.134A1 1 0 0 0 14 3v18a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V6.464a1 1 0 0 0-.5-.866l-6-3.464zM9 2a1 1 0 0 0-1 1v18a1 1 0 1 0 2 0V3a1 1 0 0 0-1-1z"></path>}
        </svg>
    );
};
...
const ShuffleIcon = ({ width = 16, height = 16, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
const PrevIcon = ({ width = 16, height = 16, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
const NextIcon = ({ width = 16, height = 16, className }) => {
    return (
        <svg
            width={width}
            height={height}
        ...
        <>
            {replayOne ? (
                <svg
                    ...
                    aria-hidden="true"
                    viewBox="0 0 16 16"
                    className={`first-letter:Svg-sc-ytk21e-0 kPpCsU ${className}`}
                >
        ...
        <>
            {level === 'low' && (
                <svg
                    ...
                    id="volume-icon"
                    viewBox="0 0 16 16"
                    className={`Svg-sc-ytk21e-0 dAOlPY ${className}`}
                >
...
const VolumeMuteIcon = ({ width = 16, height = 16, className }) => {
    return (
        <svg
            width={width}
            height={height}
...
const VerifyIcon = ({ width = 24, height = 24, className }) => {
    return (
        <svg
            width={width}
            height={height}
            ...
            role="img"
            aria-hidden="true"
            className={`Svg-sc-ytk21e-0 jdUiGa b0NcxAbHvRbqgs2S8QDg ${className}`}
            viewBox="0 0 24 24"
        >
...
const HeartIcon = ({ width = 24, height = 24, className, isLiked = false }) => {
    return (
        <svg
            width={width}
            height={height}
